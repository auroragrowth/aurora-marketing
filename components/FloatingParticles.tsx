...
const PARTICLES: Particle[] = [
  { left: 6,  size: 4, colour: "#22d3ee", variant: 1, delay: 0 },
  { left: 12, size: 3, colour: "#a78bfa", variant: 2, delay: -8 },
  { left: 18, size: 5, colour: "#fb923c", variant: 3, delay: -16 },
  { left: 25, size: 3, colour: "#ec4899", variant: 1, delay: -4 },
  { left: 33, size: 4, colour: "#22d3ee", variant: 2, delay: -22 },
  { left: 42, size: 6, colour: "#a78bfa", variant: 3, delay: -12 },
  { left: 50, size: 3, colour: "#fb923c", variant: 1, delay: -18 },
  { left: 58, size: 4, colour: "#ec4899", variant: 2, delay: -6 },
  { left: 66, size: 5, colour: "#22d3ee", variant: 3, delay: -28 },
  { left: 73, size: 3, colour: "#a78bfa", variant: 1, delay: -14 },
  { left: 81, size: 4, colour: "#fb923c", variant: 2, delay: -2 },
  { left: 88, size: 5, colour: "#ec4899", variant: 3, delay: -20 },
  { left: 94, size: 3, colour: "#22d3ee", variant: 1, delay: -10 },
];
      ...
      {PARTICLES.map((p, i) => (
        <span
          ...
          style={{
            ...
            height: `${p.size}px`,
            background: p.colour,
            boxShadow: `0 0 ${p.size * 3}px ${p.colour}`,
